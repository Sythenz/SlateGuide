...
#include "SlateGuideNotificationInfo.h"
...
#define LOCTEXT_NAMESPACE "FSlateGuideNotificationInfoModule"

void FSlateGuideNotificationInfoModule::StartupModule()
{
	// This code will execute after your module is loaded into memory; the exact timing is specified in the .uplugin file per-module
}

void FSlateGuideNotificationInfoModule::ShutdownModule()
{
